...
const file_rpc_proto_rawDesc = "" +
	"\n" +
	"\trpc.proto\x12\x04game\"*\n" +
	"\x0fFindRoomRequest\x12\x17\n" +
	"\aroom_id\x18\x01 \x01(\x05R\x06roomId\"+\n" +
	"\x10FindRoomResponse\x12\x17\n" +
	"\aroom_id\x18\x01 \x01(\x05R\x06roomIdB9Z7github.com/byteweap/wukong/examples/game/internal/pb;pbb\x06proto3"
...
var file_rpc_proto_goTypes = []any{
	(*FindRoomRequest)(nil),  // 0: game.FindRoomRequest
	(*FindRoomResponse)(nil), // 1: game.FindRoomResponse
}
