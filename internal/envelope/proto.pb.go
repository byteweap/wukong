...
func (x *ProtoEnvelope) GetSeq() uint64 {
	if x != nil {
		return x.Seq
	}
	return 0
...
func (x *ProtoEnvelope) GetCmd() uint32 {
	if x != nil {
		return x.Cmd
	}
	return 0
...
func (x *ProtoEnvelope) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
const file_proto_proto_rawDesc = "" +
	"\n" +
	"\vproto.proto\x12\benvelope\"M\n" +
	"\rProtoEnvelope\x12\x10\n" +
...
var file_proto_proto_goTypes = []any{
	(*ProtoEnvelope)(nil), // 0: envelope.ProtoEnvelope
}
